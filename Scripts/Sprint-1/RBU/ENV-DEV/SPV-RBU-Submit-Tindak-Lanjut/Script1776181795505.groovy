...
WebUI.waitForElementPresent(findTestObject('Object Repository/Sprint1/RBU/SPV-Assign-PIC/Page_ApplicationsCatalog/div_Risk Control Unit ApplicationRCU Apps c_31ac98'), 
    20)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Sprint1/RBU/SPV-Assign-PIC/Page_Dashboard/div_Tindak Lanjut'), 
    10)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Sprint1/RBU/SPV-RBU-Submit-Tindak-Lanjut/Page_TindakLanjutPettyCash/input__b3-b2-b1-StartDate'), 
    10)
