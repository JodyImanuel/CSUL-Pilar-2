...
WebUI.click(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/div_Ruang Admin_osui-accordion-item__icon o_e07bf6'))

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/a_View Detail'))

WebUI.setText(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/input_Tenggat Waktu Penyelesaian_b3-b3-b2-l_ec7e9d'), 
    '29-03-2026')

WebUI.setText(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/input_Tindak Lanjut_b3-b3-b2-l1-282_0-b20-b_237b50'), 
    'Done, tolong di cek kembali')

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/button_Unggah'))

WebUI.uploadFile(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/div_Drag  drop files orBrowseSupported form_12d9d4'), 
    Lorem1)

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/button_Simpan'))

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/PIC-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/button_Simpan_1'))
