...
WebUI.setText(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacility/input_Tanggal Penugasan_b3-b1-b1-StartDate'), 
    '23-02-2026')

WebUI.setText(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacility/input__b3-b1-b1-EndDate'), 
    '23-02-2026')
...
WebUI.click(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/div_Ruang Admin_osui-accordion-item__icon o_e07bf6'))

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityDetail/button_Tindak Lanjut'))

WebUI.selectOptionByValue(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityPersetujuan/select_Select a categorySelesaiSedang Berja_127797'), 
    '0', true)

WebUI.setText(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityPersetujuan/textarea_Catatan_b3-l1-328_0-b2-TextArea_Remarks'), 
    'Done ya')

WebUI.click(findTestObject('Object Repository/Sprint2/CBU/SPV-CBU-Submit-Tindak-Lanjut/Page_TindakLanjutUtilityFacilityPersetujuan/button_Submit'))
